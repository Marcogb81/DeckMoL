...
from pbmenuII import *



# Main class
class pbfunctionII(QDialog, Ui_Dialog):
    def __init__(self):
...
action = QAction("DeckMoL", mw)
# set it to call pbfunction when it's clicked
action.triggered.connect(pbfunctionII)
